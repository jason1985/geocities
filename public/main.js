...
module.exports = function(el) {
  return new Toasty(el);
};

},{"./lib/Toasty.js":3}],3:[function(require,module,exports){
...
{
  /**
   * Set up a toasty guy to be triggered by an element click or programmatically
  ...
  */
  trigger() {
    ...
    return this.slideIn()
      .then(function() {
      return this._delayUntilSlideOut();
    }.bind(this))
      .then(function() {
  ...
  _delayUntilSlideOut() {
    return new Promise(function(resolve) {
      return setTimeout(resolve, DELAY_UNTIL_SLIDE_OUT);
    });
  }
  ...
  slideOut() {
    return new Promise(function(resolve) {
      css(this.toastyGuy, { right: `-${this.toastyGuy.offsetWidth}px` }, SLIDE_OUT_SPEED, function() {
...
},{"./partials/audio.js":4,"./partials/toasty-guy.js":5,"css-transition":6}],4:[function(require,module,exports){
module.exports = `<audio preload="auto">
